...
$report=new PluginReportsAutoReport("Repport interventions IT");
...
#	   , new PluginReportsColumn('users_id', __('ID User'))
	   ...
	   , new PluginReportsColumn('waiting_duration', __('Delai d attente'))
	   , new PluginReportsColumn('close_delay_stat', __('Delai de fermeture'))
