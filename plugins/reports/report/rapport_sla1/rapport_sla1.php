...
, CASE 
   ...
   ELSE 'INCONNU'
   END  as Statut 
,CASE   WHEN sla.definition_time = 'second' then tik.solve_delay_stat 
		WHEN sla.definition_time = 'minute' then tik.solve_delay_stat  
		WHEN sla.definition_time = 'hour' then tik.solve_delay_stat   
		WHEN sla.definition_time = 'day' then tik.solve_delay_stat 
		WHEN sla.definition_time = 'week' then tik.solve_delay_stat  
		WHEN sla.definition_time = 'month' then tik.solve_delay_stat  
	END AS diff
